...
import PolarizedInputsdel from './PolarizedInputsdel';
      ...
      >
        {(handleSubmit, {error, data}) => {
          ...
          return (
           <Frame>
              {showToast}
              <Page title="Polarized (Basic)" description="desc">
                              ...
                              axios.post("/admin/file",formData,config)
                                .then((response) => {
                                    ...
                                    for (let j = 0; j < response.data.data.length; j++) {
                                      ...
                                      metadat[j] = {
                                        "namespace": "polarized_lenses",
                                        "key": "polarized_"+milliseconds,
...
export default PolarizedInputs;
