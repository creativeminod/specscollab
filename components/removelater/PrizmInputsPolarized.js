...
import PrizmInputsPolarizeddel from './PrizmInputsPolarizeddel';
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="Polarized" description="desc">
                ...
                <PrizmInputsPolarizeddel />
      
    </>
  );
};
export default PrizmInputsPolarized;
