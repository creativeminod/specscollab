...
import PolarizedInputsPrizmdel from './PolarizedInputsPrizmdel';
      ...
      >
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              {showToast}
              <Page title="Polarized (Prizm)" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {  
                              ...
                              if(inputFields[0].image_url != ''){
                                metadat = {
                                  "namespace": "polarized_prizm",
                                  "key": "polarized_pr_"+milliseconds,
        ...
        <PolarizedInputsPrizmdel />
      
    </>
  );
};
export default PolarizedInputsPrizm;
