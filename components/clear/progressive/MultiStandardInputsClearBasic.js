  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        clr_pr_clr: metafield(namespace: "clr_pr_clr", key: "clr_pr_clr") {
          id
          key
          namespace
          value
...
const MultiStandardInputsClearBasic = () => {
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="Standard Clear Basic(Non-mirrored)" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {
                            if(inputFields[0].image_url != ''){
                                ...
                                const metadat = {
                                  "namespace": "clr_pr_clr",
                                  "key": "clr_pr_clr_"+milliseconds,
...
export default MultiStandardInputsClearBasic;
