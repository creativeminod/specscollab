...
import StandardInputsClearTransitiondel from './StandardInputsClearTransitiondel';
...
const StandardInputsClearTransition = () => {
          ...
          return (
            <Frame>
              ...
              <Page title="Sunglass -> SINGLE VISION -> Standard (Non-Polarized)" description="desc">
                ...
                <StandardInputsClearTransitiondel />
      
    </>
  );
};
export default StandardInputsClearTransition;
