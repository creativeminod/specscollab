...
import StandardInputsClearBasicdel from './StandardInputsClearBasicdel';
...
const StandardInputsClearBasic = () => {
          ...
          return (
            <Frame>
              ...
              <Page title="Sunglass -> SINGLE VISION -> Standard (Non-Polarized)" description="desc">
                ...
                <StandardInputsClearBasicdel />
      
    </>
  );
};
export default StandardInputsClearBasic;
