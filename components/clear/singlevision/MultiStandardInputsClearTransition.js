  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        clr_sv_tc: metafield(namespace: "clr_sv_tc", key: "clr_sv_tc") {
          id
          key
          namespace
          value
...
const MultiStandardInputsClearTransition = () => {
...
export default MultiStandardInputsClearTransition;
