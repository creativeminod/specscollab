  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        sg_pr_std_np: metafield(namespace: "sg_pr_std_np", key: "sg_pr_std_np") {
          id
          key
          namespace
          value
...
const MultiStandardInputsSunNonpol = () => {
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="Standard Non-Polarised(Non-mirrored)" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {
                            if(inputFields[0].image_url != ''){
                                ...
                                const metadat = {
                                  "namespace": "sg_pr_std_np",
                                  "key": "sg_pr_std_np_"+milliseconds,
...
export default MultiStandardInputsSunNonpol;
