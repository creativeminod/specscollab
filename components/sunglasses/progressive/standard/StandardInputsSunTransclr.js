...
import StandardInputsSunTransclrdel from './StandardInputsSunTransclrdel';
...
const StandardInputsSunTransclr = () => {
          ...
          return (
            <Frame>
              ...
              <Page title="Sunglass -> SINGLE VISION -> Standard (Non-Polarized)" description="desc">
                ...
                <StandardInputsSunTransclrdel />
      
    </>
  );
};
export default StandardInputsSunTransclr;
