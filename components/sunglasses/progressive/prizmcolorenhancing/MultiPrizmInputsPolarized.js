  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        sg_pr_pce_p: metafield(namespace: "sg_pr_pce_p", key: "sg_pr_pce_p") {
          id
          key
          namespace
          value
...
const MultiPrizmInputsPolarized = () => {
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="PRIZM POLARIZED" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {
                            if(inputFields[0].image_url != ''){
                                ...
                                const metadat = {
                                  "namespace": "sg_pr_pce_p",
                                  "key": "sg_pr_pce_p_"+milliseconds,
...
export default MultiPrizmInputsPolarized;
