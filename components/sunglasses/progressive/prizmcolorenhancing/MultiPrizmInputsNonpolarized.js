  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        sg_pr_pce_np: metafield(namespace: "sg_pr_pce_np", key: "sg_pr_pce_np") {
          id
          key
          namespace
          value
...
const MultiPrizmInputsNonpolarized = () => {
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="PRIZM NON-POLARIZED" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {
                            if(inputFields[0].image_url != ''){
                                ...
                                const metadat = {
                                  "namespace": "sg_pr_pce_np",
                                  "key": "sg_pr_pce_np_"+milliseconds,
...
export default MultiPrizmInputsNonpolarized;
