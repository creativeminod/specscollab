  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        sg_sv_ir_p: metafield(namespace: "sg_sv_ir_p", key: "sg_sv_ir_p") {
          id
          key
          namespace
          value
...
const MultiPolarizedInputsIridium = () => {
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="IRIDIUM (MIRRORED) POLARIZED" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {
                            if(inputFields[0].image_url != ''){
                                ...
                                const metadat = {
                                  "namespace": "sg_sv_ir_p",
                                  "key": "sg_sv_ir_p_"+milliseconds,
...
export default MultiPolarizedInputsIridium;
