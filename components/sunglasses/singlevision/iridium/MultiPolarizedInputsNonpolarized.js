  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        sg_sv_ir_np: metafield(namespace: "sg_sv_ir_np", key: "sg_sv_ir_np") {
          id
          key
          namespace
          value
...
const MultiPolarizedInputsNonpolarized = () => {
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="IRIDIUM (MIRRORED) Non-POLARIZED" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {
                            if(inputFields[0].image_url != ''){
                                ...
                                const metadat = {
                                  "namespace": "sg_sv_ir_np",
                                  "key": "sg_sv_ir_np_"+milliseconds,
...
export default MultiPolarizedInputsNonpolarized;
