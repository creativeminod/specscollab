  ...
  query getProducts($presc_ids: [ID!]!) {
    nodes(ids: $presc_ids) {
      ... on Product {
        ...
        descriptionHtml
        id
        sg_sv_std_p: metafield(namespace: "sg_sv_std_p", key: "sg_sv_std_p") {
          id
          key
          namespace
          value
...
const MultiStandardInputsSunPol = () => {
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="Standard Polarised (Non-mirrored)" description="desc">
                      ...
                      primaryAction={[
                        {
                          ...
                          onAction: () => {
                            if(inputFields[0].image_url != ''){
                                ...
                                const metadat = {
                                  "namespace": "sg_sv_std_p",
                                  "key": "sg_sv_std_p_"+milliseconds,
...
export default MultiStandardInputsSunPol;
