...
import StandardInputsSunBasicdel from './StandardInputsSunBasicdel';
        ...
        {(handleSubmit, {error, data}) => {
          ...
          return (
            <Frame>
              ...
              <Page title="Sunglass -> SINGLE VISION -> Standard (Basic)" description="desc">
                              ...
                              axios.post("/admin/file",formData,config)
                                .then((response) => {
                                    ...
                                    for (let j = 0; j < response.data.data.length; j++) {
                                      ...
                                      metadat[j] = {
                                        "namespace": "std_sun_basic",
                                        "key": "std_sun_basic_"+milliseconds,
                ...
                <StandardInputsSunBasicdel />
      
    </>
  );
};
export default StandardInputsSunBasic;
